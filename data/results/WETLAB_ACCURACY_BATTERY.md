...
Generated: `2026-07-29T11:25:16.863464+00:00` · **37/37** pass · 62.34s
...
| T1 | pv_faster_than_pyr | Y | `{"PV_Hz": 83.0769271850586, "Pyr_Hz": 16` | PV >> Pyr (cortical order) | Allen wet-lab order |
...
| T2 | rate_Pyr_within_1pct | Y | `{"target_Hz": 16.35121532610921, "measur` | |err| ≤ 1% (continuous-ms climb) | Allen Cre FI rate + precision_climb |
| T2 | rate_PV_within_1pct | Y | `{"target_Hz": 83.3504049172855, "measure` | |err| ≤ 1% (continuous-ms climb) | Allen Cre FI rate + precision_climb |
| T2 | rate_SST_within_1pct | Y | `{"target_Hz": 29.538052683455557, "measu` | |err| ≤ 1% (continuous-ms climb) | Allen Cre FI rate + precision_climb |
| T2 | rate_VIP_within_1pct | Y | `{"target_Hz": 34.81541758294487, "measur` | |err| ≤ 1% (continuous-ms climb) | Allen Cre FI rate + precision_climb |
| T2 | precision_all_focus_1pct | Y | `True` | True | precision_micro_climb tol=0.01 dt=0.5 si |
