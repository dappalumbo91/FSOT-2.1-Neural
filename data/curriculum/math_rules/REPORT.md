...
Generated: `2026-07-30T02:22:28.668410+00:00`
...
Runtime apply rules: **14** · Language maps: **11** · Drills: **56**  
...
| Set | Acc | n |
|-----|----:|--:|
| **Drills (worksheet)** | **1.0000** | 56 |
| GSM8K train (rule-covered only) | 1.0000 | 47 |
| GSM8K test (all) | 0.0250 | 200 |
| GSM8K test (where rules fire) | 0.0725 | 69 |

**Straight-A on rule drills (≥0.95):** PASS

Imported Math-generator rules: 1520. Runtime word-problem apply fires on 69/200 held-out items. Expand apply_rules using ARITHMETIC/ALGEBRA forms from the imported book; full GSM8K rises as more atomic rules become executable.
