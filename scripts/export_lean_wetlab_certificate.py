...
def formal_claims() -> List[Dict[str, str]]:
    return [
        ...
        {
            "lean": "FSOTNeural.fixed_lattice_ok",
            "claim": "SCALE=1e12 Fixed authority; MD not on mind path",
            "runtime": "fixed.zig SCALE; allatom_md host f64 lab",
            "wetlab_check": "structural (lab separation)",
        },
        {
            "lean": "FSOTNeural.wet_stack_ok",
            "claim": "48 AMPA / 16 NMDA / 12 quantal / 20×50µs Markov",
            "runtime": "channel_stoch_fixed / molecular_fixed / glia_fixed",
            "wetlab_check": "pathways wet cascade gate",
        },
        {
            "lean": "FSOTNeural.pair_weight_ok",
            "claim": "FSOT pair kernel zero free params (π,e,φ)",
            "runtime": "genetic_fixed.fsotPairWeight",
            "wetlab_check": "genetic network / STDP coupling",
        },
        {
            "lean": "FSOTNeural.curriculum_gates_ok",
            "claim": "≥95% ppt; PK–G8 bands; no history pollution",
            "runtime": "grade_ladder_fixed / understand_depth_fixed",
        ...
        },
        {
            ...
            "claim": "formal_panel ∧ wetlab ∧ fixed ∧ wet_stack ∧ pair ∧ curriculum ∧ scientific_panel",
            "runtime": "export_lean_wetlab_certificate.py",
            "wetlab_check": "this document",
        },
        {
            "lean": "FSOTNeural.leanStampLabel",
            "claim": "LEAN4_STAMP:scientific_panel_ok:v4.31.0:0_sorry:mind_stack",
            "runtime": "formal Certificate.lean",
            "wetlab_check": "GitHub stamp artifact",
        },
    ]
