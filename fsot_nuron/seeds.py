"""FSOT seed constants — zero free parameters. Matches FSOT-GPU / archive spine."""
...
# Neuroscience domain priors (from Lean / bio panels lineage)
NEURO_D_EFF = 13.0
NEURO_N_CHANNELS = 4.0  # Na, K, Ca, leak proxy
NEURO_P = 3.0           # voltage, calcium, plasticity state props
RESTING_S = 0.46
